...
class WidthWatershed(object):
    def __init__(self):
        ...
        self.label = "Largeur aux sections transversales pour bassin versant"
        self.description = ""
    ...
    def getParameterInfo(self):
        ...
        param_poly = arcpy.Parameter(
            displayName="Polygones des rivières",
            name="poly",
        ...
        param_zbed = arcpy.Parameter(
            displayName="Fichier de sortie - Élévation du lit",
            name="zbed",
            datatype="DERasterDataset",
            parameterType="Optional",
            direction="Output")
    ...
    def execute(self, parameters, messages):
        ...
        execute_WidthWatershed(arcpy.Raster(str_flowdir), str_poly, str_line, str_ptscs, SaveResult, r_dem, str_zbed, messages)
