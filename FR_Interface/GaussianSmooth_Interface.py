...
class GaussianSmooth(object):
    def __init__(self):
        ...
        self.description = "Interpolation des hauteurs plein-bord suivant l'écoulement"
    ...
    def getParameterInfo(self):
        ...
        param_sigma = arcpy.Parameter(
            displayName="Écart-type de la courbe gaussienne",
            name="sigma",
            datatype="GPLong",
            parameterType="Required",
            direction="Input")
        param_nbpts = arcpy.Parameter(
            displayName="Taille de fenêtre",
            name="nbpts",
            datatype="GPLong",
            parameterType="Required",
            direction="Input")
        ...
        param_interpolatedbkf = arcpy.Parameter(
            displayName="Valeurs interpolées",
