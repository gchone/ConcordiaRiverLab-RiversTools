...
class Flood(object):
    def __init__(self):
        ...
        self.label = "Inonder"
        self.description = "Propage transversalement une élévation"
    ...
    def getParameterInfo(self):
        ...
        param_elevation = arcpy.Parameter(
            displayName="Ligne d'élévations",
            name="elevation",
            datatype="GPRasterLayer",
            parameterType="Required",
            direction="Input")
        ...
        param_threshold = arcpy.Parameter(
            displayName="Seuil de modification (%)",
            name="threshold",
            datatype="GPDouble",
            parameterType="Required",
            direction="Input")
        param_maxiter = arcpy.Parameter(
            displayName="Nombre maximum d'itérations",
            name="maxiter",
            datatype="GPLong",
            parameterType="Optional",
            direction="Input")
        param_flood = arcpy.Parameter(
            displayName="Zone inondée",
            name="flood",
    ...
    def execute(self, parameters, messages):
        ...
        execute_FloodAndChannel(arcpy.Raster(str_dem), arcpy.Raster(str_elevation), arcpy.Raster(str_flowdir), None, str_frompoints,None,threshold, maxiter, str_flood,messages)
