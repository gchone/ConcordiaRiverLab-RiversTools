...
class BinaryRivers(object):
    def __init__(self):
        ...
        self.description = "Détection du chenal"
    ...
    def getParameterInfo(self):
        ...
        param_threshold = arcpy.Parameter(
            displayName="Seuil de différence d'élévation (m)",
            name="thresholdDeltaz",
            datatype="GPDouble",
            parameterType="Required",
            direction="Input")
        param_threshold2 = arcpy.Parameter(
            displayName="Seuil de pente (degrés)",
            name="thresholdSlope",
            datatype="GPDouble",
            parameterType="Required",
            direction="Input")
    ...
    def execute(self, parameters, messages):
        ...
        execute_FloodAndChannel(arcpy.Raster(str_dem), testedz, arcpy.Raster(str_flowdir), arcpy.Raster(str_slope),
                                str_frompoints, threshold_slope, threshold_growth, maxiter, str_output, messages)
